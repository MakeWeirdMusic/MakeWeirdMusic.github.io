...
<p><audio src="{{ site.s3_url }}/interview/ben-levin/ben-levin.mp3" controls preload="none" /></p>

Or, [download an mp3&nbsp;<i class="non-mwm fa fa-external-link-square"></i>]({{ site.s3_url }}/interview/ben-levin/ben-levin.mp3).
