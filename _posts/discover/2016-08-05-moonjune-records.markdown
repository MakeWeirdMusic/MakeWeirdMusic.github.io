...
- [Dwiki Dharmawan&nbsp;<i class="non-mwm fa fa-external-link-square"></i>](http://www.moonjune.com/mjr_web_2013/catalog_mjr/075_DWIKI-DHARMAWAN_So-Far-So-Close_MJR075/)
- [simakDialog's *Live at Orion*&nbsp;<i class="non-mwm fa fa-external-link-square"></i>](http://www.moonjune.com/mjr_web_2013/catalog_mjr/068_simakDialog_Live-at-Orion_MJR068/)
- [Dewa Budjana&nbsp;<i class="non-mwm fa fa-external-link-square"></i>](http://www.moonjune.com/mjr_web_2013/catalog_mjr/063_DEWA-BUDJANA_Surya-Namaskar_MJR063/)

I'll also add [Markus Reuter's *Fool of Music*&nbsp;<i class="non-mwm fa fa-external-link-square"></i>](https://markus-reuter-moonjune.bandcamp.com/album/fool-of-music-compilation-free-download) since it's free and fantastic.

And TONS of music is available for free at [**MoonJune's BandCamp site**&nbsp;<i class="non-mwm fa fa-external-link-square"></i>](https://moonjunerecords.bandcamp.com/).
{: .ad }
...
And then a couple of years later, because I started managing the band called [Soft Machine Legacy&nbsp;<i class="non-mwm fa fa-external-link-square"></i>](https://en.wikipedia.org/wiki/Soft_Machine), which is the continuation of Soft Works that is sort of Soft Machine but became Soft Works in 2001 with [Allan Holdsworth&nbsp;<i class="non-mwm fa fa-external-link-square"></i>](http://en.wikipedia.org/wiki/Allan_Holdsworth), [Elton Dean&nbsp;<i class="non-mwm fa fa-external-link-square"></i>](http://en.wikipedia.org/wiki/Elton_Dean), [Hugh Hopper&nbsp;<i class="non-mwm fa fa-external-link-square"></i>](http://en.wikipedia.org/wiki/Hugh_Hopper), and [John Marshall&nbsp;<i class="non-mwm fa fa-external-link-square"></i>](https://en.wikipedia.org/wiki/John_Marshall_(drummer))--the band then became Soft Machine Legacy with [John Etheridge&nbsp;<i class="non-mwm fa fa-external-link-square"></i>](https://en.wikipedia.org/wiki/John_Etheridge) coming in the band after Allan Holdsworth, who for whatever reason wasn't able to continue with the band. Then I started booking this band in Europe and they needed a new album because we had a great album of Soft Works with Allan, but they didn't do anything with John Etheridge in the new band, but they just changed the name of the band from Soft Works to Soft Machine Legacy.
{: .interviewee }
