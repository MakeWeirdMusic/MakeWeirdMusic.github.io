...
- [Standard Tuning]({{ site.data.artists.mwm.assets_prod }}share/harnch/ost)
- [New Standard Tuning]({{ site.data.artists.mwm.assets_prod }}share/harnch/ost) with [MIDI]({{ site.data.artists.mwm.assets_prod }}share/harnch/ost/midi) (includes [MuseScore](http://musescore.org) file)
